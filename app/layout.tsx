    ...
    <html lang="en" data-theme="dark">
      <body className="font-mono bg-neutral-900 text-white min-h-screen">
        <header className="navbar bg-neutral-950 border-b flex justify-between border-gray-700 px-6 md:px-10 py-4 shadow-lg">
          <div className="border border-gray-700 border-dashed hover:border-gray-300 rounded-full py-1 px-3 hover:text-white transition-colors text-purple-400">
            <Link
              href="/"
          ...
          <div className="flex-none">
            <Link
              ...
              className="btn btn-ghost btn-circle text-purple-400 hover:text-white transition-colors"
